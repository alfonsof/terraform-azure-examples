...
* Test the cluster of web servers.
  ...
  You can test it in two ways, but be sure to replace the value of `<LOAD_BALANCER_PUBLIC_IP>` by the public IP address that you have got in the previous command:
